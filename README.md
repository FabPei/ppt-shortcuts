...
[Recommended shortcuts](https://github.com/FabPei/ppt-shortcuts/blob/main/bin/windows/shortcuts.csv)
...
## Shortcuts
### [Prodeck](https://github.com/rodrigolourencofarinha/ProDeck/issues/6#issuecomment-3198579146)
| Label | Description | onAction |
| :--- | :--- | :--- |
| Paste Objects to Selected Slides | Paste object in the clipboard to selected slides | Paste_Objects_All_Slides |
| Updated Position of Pasted Objects | Updates the position of objects that were pasted in several slides | Update_Objects_Position |
| Delete Matching Objects from All Slides | Delete all matching objects from all slides | Delete_Similar_Objects |
| Note | Insert a sticky note in the slide | GenerateStickyNote |
| Insert Sticky Note | Insert Sticky Note | GenerateStickyNote |
| Move off this Slide | Move sticky notes off this slide | MoveStickyNotesOffSlide |
| Move on this Slide | Move sticky notes onto this slide | MoveStickyNotesOnSlide |
| Delete of this Slide | Delete sticky notes of this slide | DeleteStickyNotesOnSlide |
| Move off All Slides | Move sticky notes off all slides | MoveStickyNotesOffAllSlides |
| Move on All Slides | Move sticky notes onto all slides | MoveStickyNotesOnAllSlides |
| Delete of All Presentation | Delete all sticky notes in the presentation | DeleteStickyNotesOnAllSlides |
| Convert Comments on this Slide to Sticky Notes | Convert comments to sticky notes | ConvertCommentsToStickyNotes |
| Draw Text Box, Notes, and Templates | Draw text box anywhere | Control_Text_Box |
| Draw Text Box | Insert text box | Control_Text_Box |
| 1 Heading | Insert heading level 1 | HeadingOne |
| 2 Headings | Insert heading level 2 | HeadingTwo |
| 3 Headings | Insert heading level 3 | HeadingThree |
| 4 Headings | Insert heading level 4 | HeadingFour |
| 5 Headings | Insert heading level 5 | HeadingFive |
| 6 Headings | Insert heading level 6 | HeadingSix |
| Insert or Reposition Footnote | Insert/reposition footnote | Notes |
| Update Footnote Position on all Slides | Update all footnotes | Update_Notes |
| Text Box Margins On/Off | Toggle margins in text boxes | Margin_Toggle |
| Text Box Margins On/Off | Same (submenu version) | Margin_Toggle |
| Wrap Text On/Off | Toggle wrap text | Wrap_Text |
| Do Not AutoFit | Disable AutoFit | Do_Not_Autofit |
| Resize Shape to Fit Text | Fit shape to text | Shape_Fit_Text |
| Shrink Text on Overflow | Shrink text when overflowing | Text_Overflow |
| Fill Color | Select similar objects by fill color | Select_Similar_Fill_Color |
| Line Color | Select similar objects by line color | Select_Similar_Line_Color |
| Font Color | Select similar objects by font color | Select_Similar_Font_Color |
| All Colors | Replace all colors | Replace_All_Colors |
| Fill Colors | Replace fill colors | Replace_Fill_Colors |
| Line Colors | Replace line colors | Replace_Line_Colors |
| Font Colors | Replace font colors | Replace_Font_Colors |
| Shape 1 Right Side to Shape 2 Left Side | Connect shapes | ConnectRectangleShapesRightToLeft |
| Shape 1 Left Side to Shape 2 Right Side | Connect shapes | ConnectRectangleShapesLeftToRight |
| Shape 1 Bottom Side to Shape 2 Top Side | Connect shapes | ConnectRectangleShapesBottomToTop |
| Shape 1 Top Side to Shape 2 Bottom Side | Connect shapes | ConnectRectangleShapesTopToBottom |
| Convert Table to Shapes | Convert table | ConvertTableToShapes |
| Add column gaps | Even column gaps | TableColumnGapsEven |
| Add column gaps (including left and right sides) | Odd column gaps | TableColumnGapsOdd |
| Remove column gaps | Remove column gaps | TableColumnRemoveGaps |
| Increase column gaps | Increase spacing | TableColumnIncreaseGaps |
| Decrease column gaps | Decrease spacing | TableColumnDecreaseGaps |
| Add Row Gaps | Even row gaps | TableRowGapsEven |
| Add Row Gaps (including top and bottom sides) | Odd row gaps | TableRowGapsOdd |
| Remove Row Gaps | Remove row gaps | TableRowRemoveGaps |
| Increase row gaps | Increase spacing | TableRowIncreaseGaps |
| Decrease row gaps | Decrease spacing | TableRowDecreaseGaps |
| Clone Selection to Right | Duplicate selection | ObjectsCloneRight |
| Clone Selection Down | Duplicate selection | ObjectsCloneDown |
| Increase Horizontal Spacing | Adjust spacing | Increase_Horizontal_Spacing |
| Decrease Horizontal Spacing | Adjust spacing | Decrease_Horizontal_Spacing |
| Increase Vertical Spacing | Adjust spacing | Increase_Vertical_Spacing |
| Decrease Vertical Spacing | Adjust spacing | Decrease_Vertical_Spacing |
| Swap Positions by Center | Swap objects | Swap_Center |
| Top and Left | Swap reference | Swap_TopLeft |
| Top and Center | Swap reference | Swap_TopCenter |
| Top and Right | Swap reference | Swap_TopRight |
| Middle and Left | Swap reference | Swap_MiddleLeft |
| Center | Swap reference | Swap_Center |
| Middle and Right | Swap reference | Swap_MiddleRight |
| Bottom and Left | Swap reference | Swap_BottomLeft |
| Bottom and Center | Swap reference | Swap_BottomCenter |
| Bottom and Right | Swap reference | Swap_BottomRight |
| Text Without Formatting | Swap text without formatting | Swap_Text_NoFormat |
| Stack Above | Stack objects | Stack_Top |
| Stack Below | Stack objects | Stack_Bottom |
| Stack Left | Stack objects | Stack_Left |
| Stack Right | Stack objects | Stack_Right |
| Adjust Angles | Copy rounded corners | ObjectsCopyRoundedCorner |
| Rectify Lines | Straighten lines | RectifyLines |
| Match Height | Resize shapes | Resize_Height |
| Match Width | Resize shapes | Resize_Width |
| Match Size | Resize shapes | Resize_Shapes |
| Lock Aspect Ratio | Toggle lock/unlock | Lock_and_Unlock |
| Hide Selected Objects | Hide objects | Hide_Objects |
| Show All Objects on Selected Slides | Show objects | Show_All_Objects |
| Merge Text | Merge text boxes | Merge_Text_Boxes |
| Split Text | Split text boxes | Split_Text_Boxes |
| English (US) | Change language | Language_US |
| Portuguese (BR) | Change language | Language_BR |
| Spanish (ES) | Change language | Language_ES |
| French (FR) | Change language | Language_FR |
| German (DE) | Change language | Language_DE |
| Remove Line Breaks | Clean text | Remove_Line_Break |
| Remove Double Spaces from Selected Slides | Clean text | Remove_Spaces |
| Export Comments to Text File | Export comments | Export_Comments_Text |
| Export Notes to Text File | Export notes | Export_Notes_Text |
| Fix Slide Footers | Fix footers | Fix_Footers |
| Fix Slide Numbers | Fix slide numbers | Fix_Slide_Numbers |
| Compress Pictures | Optimize file size | CompressPicture |
| Delete Empty Shapes | Clean deck | Delete_Empty_Shapes |
| Delete All Sticky Notes | Remove sticky notes | DeleteStickyNotesOnAllSlides |
| Delete All Comments | Remove comments | Remove_All_Comments |
| Delete All Notes | Remove notes | Remove_All_Notes |
| Delete All Animations | Remove animations | Remove_All_Animations |
| Delete All Transitions | Remove transitions | Remove_Transitions |
| Delete Unused Layouts | Clean deck | Remove_Unused_Layouts |
| Anonymize Selected Slides with Lorem Ipsum | Replace text | AnonymizeWithLoremIpsum |
| DRAFT | Add slide label | StampS_Draft |
| PRELIMINARY | Add slide label | StampS_Preliminary |
| NEW | Add slide label | StampS_New |
| UPDATED | Add slide label | StampS_Updated |
| TO BE REMOVED | Add slide label | StampS_Remove |
| Bring Slide Labels to Front | Bring labels forward | StampS_Front |
| Remove All Slide Labels | Remove slide labels | StampS_Delete |
| DRAFT (content) | Add content label | StampC_Draft |
| PRELIMINARY (content) | Add content label | StampC_Preliminary |
| ILLUSTRATIVE | Add content label | StampC_Illustrative |
| NOT EXHAUSTIVE | Add content label | StampC_Not_Exhaustive |
| FOR DISCUSSION | Add content label | StampC_Discussion |
| DRAFT MATERIAL | Classify document | StampD_Draft |
| PRELIMINARY MATERIAL | Classify document | StampD_Preliminary |
| CONFIDENTIAL MATERIAL | Classify document | StampD_Confidential |
| DO NOT DISTRIBUTE | Classify document | StampD_Distibute |
| FOR INTERNAL USE ONLY | Classify document | StampD_Internal |
| Update Stamp Based on the Selected One | Update stamp | StampD_Update |
| Remove Stamp | Remove stamp | StampD_Delete |
| Insert Watermark | Add watermark | Watermark_Add |
| Remove Watermark | Remove watermark | Watermark_Delete |
| About ProDeck | About info | About |
| Go To ProDeck Tab | Switch tab | ActivateProDeckTab |
| Create Grid of Shapes | Create grid | Grid_Shapes |
### [Instrumenta](https://github.com/iappyx/Instrumenta-Keys/blob/main/instrumenta-macro-list.md?plain=1)
